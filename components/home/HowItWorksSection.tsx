...
const PASSES: Pass[] = [
  ...
  },
  {
    ...
    body: "Within one working day, your community manager calls you. We&rsquo;ll walk through the suites available for your move-in date, answer the questions Google can&rsquo;t, and unlock our booking platform. Most members decide in 2–3 days.",
    from: "Discovery",
    to: "Decision",
    time: "1–3 days",
  },
